 ...
 * 下拉列表条目
 */
public class FilterDropdownListItemView extends TextView {
    ...
    public FilterDropdownListItemView(Context context) {
        this(context, null);
    }

    public FilterDropdownListItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FilterDropdownListItemView(Context context, AttributeSet attrs, int defStyleAttr) {
