 ...
 * 下拉按钮
 */
public class FilterDropdownButton extends RelativeLayout {
    ...
    public FilterDropdownButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FilterDropdownButton(Context context, AttributeSet attrs, int defStyleAttr) {
